...
const SERVER_NAME = 'https://readline.io';
...
export default class ReadlineMain extends React.Component {
  ...
  componentDidMount() {
    ...
    this.sendChannel = new PageChannel(SERVER_NAME + '/channel/', sendChannelId);

    let clientChannelId = this.sendChannel.sessionId;
    this.recvChannel = new PageChannel(SERVER_NAME + '/channel/', clientChannelId);
    ...
    this.programStore = new ProgramStore(SERVER_NAME + '/program');
